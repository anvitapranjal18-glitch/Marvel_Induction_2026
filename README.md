...
# Marvel Project: Comprehensive Task Report

**Prepared by:** ANVITA PRANJAL
**Date:** March 2026
...
2. [TASK 2: API](#task-2)
3. [TASK 3: Working with Github](#task-3)
4. [TASK 4: Get familiar with the command line on ubuntu and do the following subtasks](#task-4)
5. [TASK 7: Create a Portfolio Webpage](#task-7)
6. [TASK 8: Writing Resource Article using Markdown](#task-8)
7. [TASK 9: Tinkercad](#task-9)
8. [TASK 10: Speed Control of DC Motor](#task-10)
9. [TASK 11: LED Toggle Using ESP32](#task-11)
10. [TASK 12: Soldering Prerequisites](#task-12)
11. [Design a 555 astable multivibrator with duty cycle 60%, rig up the circuit on a breadboard and by using the probes observe the output of your circuit on the DSO](#task-13)
12. [TASK 14: Karnaugh Maps and Deriving the logic circuit](#task-14)
13. [TASK 15: Active Participation:](#task-15)
14. [TASK 16: Datasheets report writing:](#task-16)
15. [Task 17: Introduction to VR](#task-17)
16. [TASK 18: Sad servers - "Like LeetCode for Linux"](#task-18)
